...
function (t, i) {
    ...
    return d.prototype.addElementBackgroundImages = function (e) {
        ...
        this.isComplete = !0, this.emitEvent(t, [this]), this.emitEvent("always", [this]), this.jqDeferred && (e = this.hasAnyBroken ? "reject" : "resolve", this.jqDeferred[e](this))
    ...
    function o(h, n, l) {
        (l = l || e || t.jQuery) && (n.prototype.option || (n.prototype.option = function (t) {
            ...
            return r = i, u = "$()." + h + '("' + (s = t) + '")', (e = this).each(function (t, e) {
                ...
                n ? (i = n[s]) && "_" != s.charAt(0) ? (o = i.apply(n, r), a = void 0 === a ? o : a) : c(u + " is not a valid method") : c(h + " not initialized. Cannot call methods, i.e. " + u)
            }), void 0 !== a ? a : e
        }, s(l))
    }
...
function (t, e) {
    ...
    function L(t) {
        var e, i, o;
        if (E || (E = !0, (e = document.createElement("div")).style.width = "200px", e.style.padding = "1px 2px 3px 4px", e.style.borderStyle = "solid", e.style.borderWidth = "1px 2px 3px 4px", e.style.boxSizing = "border-box", (i = document.body || document.documentElement).appendChild(e), o = S(e), b = 200 == Math.round(z(o.width)), L.isBoxSizeOuter = b, i.removeChild(e)), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
            var n = S(t);
            ...
            var _ = z(n.height);
            return !1 !== _ && (s.height = _ + (g ? 0 : c + y)), s.innerWidth = s.width - (d + p), s.innerHeight = s.height - (c + y), s.outerWidth = s.width + m, s.outerHeight = s.height + f, s
        }
    }
    return L
}),
...
function (t, e) {
    ...
    u.constructor = a, u._create = function () {
        ...
        this.setPosition(t, e), !a || this.isTransitioning ? (i = t - s, o = e - r, (n = {}).transform = this.getTranslate(i, o), this.transition({
            to: n,
            onTransitionEnd: {
...
function (n, s) {
    ...
    function l(t, e) {
        ...
        o ? (this.element = o, a && (this.$element = a(this.element)), this.options = s.extend({}, this.constructor.defaults), this.option(e), i = ++u, this.element.outlayerGUID = i, (h[i] = this)._create(), this._getOption("initLayout") && this.layout()) : r && r.error("Bad element for " + this.constructor.namespace + ": " + (o || t))
    }
    ...
    s.extend(d, e.prototype), d.option = function (t) {
        ...
        this.emitEvent(t, n), a && (this.$element = this.$element || a(this.element), e ? ((o = a.Event(e)).type = t, this.$element.trigger(o, i)) : this.$element.trigger(t, i))
    }, d.ignore = function (t) {
        ...
        var i = c(l);
        return i.defaults = s.extend({}, l.defaults), s.extend(i.defaults, e), i.compatOptions = s.extend({}, l.compatOptions), i.namespace = t, i.data = l.data, i.Item = c(o), s.htmlInit(i, t), a && a.bridget && a.bridget(t, i), i
    };
    var m = {
        ms: 1,
        s: 1e3
...
function (r, a) {
    ...
    h.sortDataParsers = {
        ...
        var t, e, r, a;
        this.options.sortBy && (t = s.makeArray(this.options.sortBy), this._getIsSameSortBy(t) || (this.sortHistory = t.concat(this.sortHistory)), r = this.sortHistory, a = this.options.sortAscending, e = function (t, e) {
...
! function (e) {
    ...
    13: function (e, t) {
                ...
                if (null != r) {
                    ...
                    try {
                        if (o = (r = r.call(e)).next, 0 === t) {
                            ...
                            for (; !(f = (a = o.call(r)).done) && (l.push(a.value), l.length !== t); f = !0);
                    } catch (e) {
                        s = !0, n = e
                    } finally {
                        try {
        ...
        jQuery(window).on("elementor/frontend/init", (function () {
            function e(e, t, r) {
                var a = r("#eael-fg-no-items-found", t).css("font-size");
                r(".eael-filter-gallery-container", t).css("min-height", 2 * parseInt(a) + "px"), e.data("isotope").filteredItems.length ? r("#eael-fg-no-items-found", t).hide() : r("#eael-fg-no-items-found", t).show()
            }
            if (eael.elementStatusCheck("eaelFilterableGallery")) return !1;
            elementorFrontend.hooks.addAction("frontend/element_ready/eael-filterable-gallery.default", (function (t, n) {
                var o, i, l, f, s = t.find(".fg-layout-3-filter-controls").eq(0),
                    c = t.find("#fg-filter-trigger"),
                    u = t.find(".fg-layout-3-search-box"),
                    d = t.find("#fg-search-box-input"),
                    p = null === (o = localize) || void 0 === o || null === (o = o.eael_translate_text) || void 0 === o ? void 0 : o.fg_mfp_counter_text;
                p = p ? "%curr% " + p + " %total%" : "%curr% of %total%";
                var m = n(".eael-filter-gallery-wrapper", t),
                    g = m.data("custom_default_control"),
                    y = m.data("default_control_key");
                if (g = void 0 !== g ? parseInt(g) : 0, y = void 0 !== y ? parseInt(y) : 0, u.length && u.on("submit", (function (e) {
                        e.preventDefault()
                    })), c.on("click", (function () {
                        s.toggleClass("open-filters")
                    })), c.on("blur", (function () {
                        s.removeClass("open-filters")
                    })), n(".video-popup.eael-magnific-video-link.playout-vertical", t).on("click", (function () {
                        setTimeout((function () {
                            n(".mfp-iframe-holder").addClass("eael-gf-vertical-video-popup")
                        }), 1)
                    })), n(".eael-magnific-link", t).on("click", (function () {
                        setTimeout((function () {
                            n(".mfp-wrap").addClass("eael-gf-mfp-popup")
                        }), 1)
                    })), n(document).on("click", ".mfp-arrow.mfp-arrow-left, .mfp-arrow.mfp-arrow-right", (function () {
                        setTimeout((function () {
                            var e = n(".eael-gf-mfp-popup .mfp-container");
                            if (e.hasClass("mfp-iframe-holder")) {
                                var t = n("iframe", e).attr("src");
                                if ((a = n('a[href="' + t + '"]')).length < 1) var r = function (e) {
                                        var t = e.match(/\/\/(?:player\.)?vimeo.com\/(?:video\/)?([0-9]+)/);
                                        if (t) return t[1];
                                        var r = e.match(/(?:https?:\/\/)?(?:www\.)?(?:youtube\.com\/(?:[^\/\n\s]+\/\S+\/|(?:v|e(?:mbed)?)\/|\S*?[?&]v=)|youtu\.be\/)([a-zA-Z0-9_-]{11})/);
                                        return r ? r[1] : null
                                    }(t),
                                    a = n('a[href*="' + r + '"]');
                                a.hasClass("playout-vertical") ? e.addClass("eael-gf-vertical-video-popup") : e.removeClass("eael-gf-vertical-video-popup")
                            }
                        }), 1)
                    })), !isEditMode) {
                    var v = n(".eael-filter-gallery-container", t),
                        h = v.data("settings"),
                        b = JSON.parse(atob(v.data("gallery-items"))),
                        w = "masonry" === h.grid_style ? "masonry" : "fitRows",
                        k = "yes" === h.gallery_enabled,
                        x = v.data("images-per-page"),
                        _ = v.data("init-show"),
                        C = v.data("is-randomize");
                    if (isRTL = n("body").hasClass("rtl"), "yes" === C) {
                        b = function (e) {
                            for (var t = 0; t < e.length - 1; t++) {
                                var r = t + Math.floor(Math.random() * (e.length - t)),
                                    a = e[r];
                                e[r] = e[t], e[t] = a
                            }
                            return e
                        }(b), v.empty();
                        for (var A = 0; A < _; A++) v.append(b[A])
                    }
                    b.splice(0, _);
                    var S = n(".eael-filter-gallery-wrapper").data("layout-mode"),
                        j = v.isotope({
                            itemSelector: ".eael-filterable-gallery-item-wrap",
                            layoutMode: w,
                            percentPosition: !0,
                            stagger: 30,
                            transitionDuration: h.duration + "ms",
                            isOriginLeft: !isRTL,
                            filter: function () {
                                var e = n(this),
                                    r = !i || e.text().match(i);
                                void 0 === l && (l = "layout_3" !== S ? t.find(".eael-filter-gallery-control ul li").first().data("filter") : t.find(".fg-layout-3-filter-controls li").first().data("filter"));
                                var a = !l || e.is(l);
                                return r && a
                            }
                        });
                    n(t).magnificPopup({
                        ...
                        callbacks: {
                            markupParse: function (e, t, r) {
                                "" !== r.el.attr("title") && (t.title = r.el.attr("title"))
                            },
                            open: function () {
                                setTimeout((function () {
                                    n(".eael-privacy-message").remove()
                                }), 5e3), setTimeout((function () {
                                    var e = n(".dialog-type-lightbox.elementor-lightbox");
                                    e.length > 0 && e.remove(), n(".e--ua-safari .eael-gf-mfp-popup iframe.mfp-iframe").on("load", (function () {
                                        var e = this.contentDocument || this.contentWindow.document;
                                        n(e).find("video").removeClass("mac")
                                    }))
                                }), 100)
                            }
                        }
                    }), t.on("click", ".control", (function () {
                        var o = n(this);
                        l = n(this).attr("data-filter");
                        var i = n(".eael-filter-gallery-container .eael-filterable-gallery-item-wrap" + l, t).length,
                            f = t.find("#fg-filter-trigger > span");
                        f.length && f.text(o.text());
                        var s = parseInt(o.data("first-init"));
                        if (!s) {
                            o.data("first-init", 1);
                            var c = i,
                                u = $items = [];
                            if ("string" == typeof x && (x = _), c < x) {
                                var d, p = a(b.entries());
                                try {
                                    for (p.s(); !(d = p.n()).done;) {
                                        var m = r(d.value, 2),
                                            g = m[0],
                                            y = m[1];
                                        if ("" !== l && "*" !== l) n(n(y)[0]).is(l) && (++c, $items.push(n(y)[0]), u.push(g));
                                        if (c >= x) break
                                    }
                                } catch (e) {
                                    p.e(e)
                            ...
                            $items.length > 0 && ($items = $items.filter((function (e) {
                                return "number" != typeof e
                            }))), u.length > 0 && (b = b.filter((function (e, t) {
                                return !u.includes(t)
                            })))
                        }
                        var h = n(this).data("load-more-status"),
                            w = n(".eael-gallery-load-more", t),
                            k = l.replace(".", ""),
                            C = b.filter((function (e) {
                                return e.includes(k)
                            })).length;
                        if (C < 1 && "*" === o.data("filter")) {
                            var A = n(".eael-filter-gallery-container .eael-filterable-gallery-item-wrap", t).length,
                                S = v.data("total-gallery-items");
                            C = Number(S) - Number(A)
                        }
                        h || C < 1 ? w.hide() : w.show(), o.siblings().removeClass("active"), o.addClass("active"), !s && $items.length > 0 ? (j.isotope(), v.append($items), j.isotope("appended", $items), j.imagesLoaded().progress((function () {
                            j.isotope("layout")
                        }))) : j.isotope(), o.hasClass("all-control") ? h || b.length <= 1 ? w.hide() : w.show() : n(l + " .eael-magnific-link").addClass("active"), e(j, t, n)
                    })), n(".eael-filter-gallery-control li.control", t).keydown((function (e) {
                        if ("ArrowRight" === e.key || "ArrowLeft" === e.key) {
                            var r = n(".eael-filter-gallery-control li.control", t),
                                a = n(".eael-filter-gallery-control li.control.active", t),
                                o = a < 0 ? r.index(this) : r.index(a);
                            "ArrowRight" === e.key && (o = (o + 1) % r.length), "ArrowLeft" === e.key && (o = (o - 1 + r.length) % r.length), n(r[o]).focus().click()
                        }
                    })), n(".eael-filter-gallery-control li.control", t).attr("tabindex", "-1"), n(".eael-filter-gallery-control li.control.active", t).attr("tabindex", "0");
                    var T = !1;
                    d.on("input", (function () {
                        var e = n(this),
                            o = [];
                        if (!T && "yes" === v.data("search-all")) {
                            var l, s = a(b.entries());
                            try {
                                for (s.s(); !(l = s.n()).done;) {
                                    var c = r(l.value, 2),
                            ...
                            j.isotope(), v.append(o), j.isotope("appended", o), j.imagesLoaded().progress((function () {
                                j.isotope("layout")
                            })), n(".eael-gallery-load-more", t).hide(), T = !0
                        }
                        clearTimeout(f), f = setTimeout((function () {
                            i = new RegExp(e.val(), "gi"), j.isotope()
                        }), 600)
                    })), j.imagesLoaded().progress((function () {
                        j.isotope("layout")
                    })), j.on("arrangeComplete", (function () {
                        e(j, t, n)
                    })), n(window).on("load", (function () {
                        j.isotope("layout")
                    })), t.on("click", ".eael-gallery-load-more", (function (o) {
                        o.preventDefault();
                        var i = n(this),
                            l = v.data("nomore-item-text"),
                            f = (n(".eael-filter-gallery-control", t).length, []),
                            c = n(".eael-filter-gallery-control li.active", t).data("filter");
                        s.length > 0 && (c = n(".fg-layout-3-filter-controls li.active", t).data("filter")), void 0 === c && (c = "*");
                        var u, d = 0,
                            p = [],
                            m = a(b.entries());
                        try {
                            for (m.s(); !(u = m.n()).done;) {
                                var g = r(u.value, 2),
                                    y = g[0],
                                    h = g[1];
                                if (n(n(h)[0]).is(c) && (++d, f.push(n(h)[0]), p.push(y)), "" !== c && "*" !== c && b.length - 1 === y && (n(".eael-filter-gallery-control li.active", t).data("load-more-status", 1), i.hide()), d === x) break
                            }
                        } catch (e) {
                            m.e(e)
                        } finally {
                        ...
                        p.length > 0 && (b = b.filter((function (e, t) {
                            return !p.includes(t)
                        }))), b.length < 1 && (i.html('<div class="no-more-items-text"></div>'), i.children(".no-more-items-text").text(l), setTimeout((function () {
                            i.fadeOut("slow")
                        }), 600)), v.append(f), j.isotope("appended", f), j.imagesLoaded().progress((function () {
                            j.isotope("layout")
                        })), e(j, t, n)
                    })), n(document).on("mouseup", (function (e) {
                        c.is(e.target) || 0 !== c.has(e.target).length || s.removeClass("open-filters")
                    })), n(document).ready((function () {
                        if (window.location.hash) jQuery("#" + window.location.hash.substring(1)).trigger("click");
                        else if (g) {
                            var e = h.control_all_text ? 2 : 1;
                            y += e, jQuery(".eael-filter-gallery-control li:nth-child(".concat(y, ")")).trigger("click")
                        }
                    }));
                    var O = function (e) {
                        j.imagesLoaded().progress((function () {
                    ...
                    eael.hooks.addAction("ea-toggle-triggered", "ea", O), eael.hooks.addAction("ea-lightbox-triggered", "ea", O), eael.hooks.addAction("ea-advanced-tabs-triggered", "ea", O), eael.hooks.addAction("ea-advanced-accordion-triggered", "ea", O)
                }
            }))
        }))
    }
